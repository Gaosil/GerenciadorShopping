package br.unisinos.shopping.validadores;
...
import br.unisinos.shopping.tipos.Shopping;
...
public class ValidadorEtapa4 {
	...
	public static void main(String[] args){
		...
		System.out.println(total == 1 ? "[OK] Método Shopping.quantidadeLojasPorTipo() - localizou duas lojas" : "[NOK] Método Shopping.quantidadeLojasPorTipo() - não conseguiu localizar as lojas");
